export const ERR = {
  ...
  INVALID_VARIANT: {
    ...
    message: '요청한 variant가 올바르지 않습니다',
  },
  VARIANT_NOT_FOUND: {
    code: 'VARIANT_NOT_FOUND',
    message: 'variant를 찾을 수 없습니다',
  },
  ...
  RETURN_NOT_ALLOWED: {
    ...
    message: '반품 요청이 불가능한 상태입니다',
  },
  RETURN_ALREADY_EXISTS: {
    code: 'RETURN_ALREADY_EXISTS',
    message: '이미 반품 요청이 존재합니다',
  },
  ...
  // qna
  ASK_LIMIT_EXCEEDED: {
    code: 'ASK_LIMIT_EXCEEDED',
    message: '문의는 최대 3개까지 등록할 수 있습니다.',
  },
} as const;
